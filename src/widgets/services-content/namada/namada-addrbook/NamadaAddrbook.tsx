...
const NamadaAddrbook:FC<TendermintContentProps> = ({network, chainId}) => {
    return (
        <div className={styles.container}>
            <ContentItem title={"DOWNLOAD ADDRBOOK"}>
                {`wget -O $HOME/${network.other.working_dir}/${chainId}/cometbft/config/addrbook.json https://download.dteam.tech/${network.name
