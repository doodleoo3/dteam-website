    ...
    return (
        <div className={styles.overview__container}>
            <div className={styles.left__side__wrapper}>
                <NetworkOverviewInfo network={network} chainId={networkParams?.chain_id} nodeVersion={networkParams?.version && !network.other.version ? networkParams.version : network.other.version} validatorStatus={networkParams?.validator_status} valueOfStakedTokens={networkParams?.staked_value} amountOfTokens={networkParams?.staked_tokens}/>
