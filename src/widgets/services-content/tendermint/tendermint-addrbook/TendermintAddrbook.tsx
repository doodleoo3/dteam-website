...
const NamadaAddrbook = dynamic(() => import("@/src/widgets/services-content/namada/namada-addrbook/NamadaAddrbook"))

const TendermintAddrbook:FC<TendermintContentProps> = ({network, chainId}) => {
    if (network.name === "namada") {
        return (
            <NamadaAddrbook network={network} chainId={chainId}/>
        );
    }
