...
const NamadaGenesis = dynamic(() => import("@/src/widgets/services-content/namada/namada-genesis/NamadaGenesis"))

const TendermintGenesis:FC<TendermintContentProps> = ({network, chainId}) => {
    if (network.name === "namada") {
        return (
            <NamadaGenesis network={network} chainId={chainId} />
        );
    }
