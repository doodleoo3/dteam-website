...
const CelestiaLightInstallationGuide:FC<TendermintContentProps> = ({network}) => {
    return (
...
# Example: celestia light init --core.ip https://rpc.celestia.${network.type}.dteam.tech:443
celestia light init --core.ip <CONSENSUS_NODE_RPC_ENDPOINT>`}
                    </ContentItem>
                }
...
# Example: celestia light init --core.ip https://rpc.celestia.${network.type}.dteam.tech:443 --p2p.network mocha
celestia light init --core.ip <CONSENSUS_NODE_RPC_ENDPOINT> --p2p.network mocha`}
                    </ContentItem>
                }
...
[Unit]
Description=${network.name} ${network.type} light node
...
export default CelestiaLightInstallationGuide;