...
const CelestiaFullInstallationGuide:FC<TendermintContentProps> = ({network}) => {
    return (
...
# Example: celestia full init --core.ip https://rpc.celestia.${network.type}.dteam.tech:443
celestia full init --core.ip <CONSENSUS_NODE_RPC_ENDPOINT>`}
                    </ContentItem>
                }
...
# Example: celestia full init --core.ip https://rpc.celestia.${network.type}.dteam.tech:443 --p2p.network mocha
celestia full init --core.ip <CONSENSUS_NODE_RPC_ENDPOINT> --p2p.network mocha`}
                    </ContentItem>
                }
...
[Unit]
Description=${network.name} ${network.type} full node
...
export default CelestiaFullInstallationGuide;